...
public class Program
{
    ...
    {
        Console.WriteLine("===== Test from random-qs -- hello :D =====");

        if (args.Length == 0)
        {
            throw new ArgumentException("Error: Need command line argument for filename containing data -- E.g. dotnet run CarData.txt");
        }
